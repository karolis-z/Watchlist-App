...
@Entity(tableName = "remote_key_discover_tv")
data class RemoteKeyDiscoverTV(
...
@Entity(tableName = "title_item_cache_discover_tv")
data class TitleItemCacheDiscoverTV(
...
@Entity(
    tableName = "genre_for_cache_item_discover_tv",
    primaryKeys = ["id", "titleId"],
    foreignKeys = [ForeignKey(
        entity = TitleItemCacheDiscoverTV::class,
        parentColumns = ["id"],
...
data class GenreForCacheItemDiscoverTV(
...
data class TitleItemCacheDiscoverTVFull(
    @Embedded override val titleItem: TitleItemCacheDiscoverTV,
    @Relation(
        parentColumn = "id",
        entityColumn = "titleId",
        entity = GenreForCacheItemDiscoverTV::class,
        projection = ["id","name"]
    )
