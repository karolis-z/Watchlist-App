...
@Entity(tableName = "remote_key_popular_movie")
data class RemoteKeyPopularMovie(
...
@Entity(tableName = "title_item_cache_popular_movie")
data class TitleItemCachePopularMovie(
...
@Entity(
    tableName = "genre_for_cache_item_popular_movie",
    primaryKeys = ["id", "titleId"],
    foreignKeys = [ForeignKey(
        entity = TitleItemCachePopularMovie::class,
        parentColumns = ["id"],
...
data class GenreForCacheItemPopularMovie(
...
data class TitleItemCachePopularMovieFull(
    @Embedded override val titleItem: TitleItemCachePopularMovie,
    @Relation(
        parentColumn = "id",
        entityColumn = "titleId",
        entity = GenreForCacheItemPopularMovie::class,
        projection = ["id","name"]
    )
