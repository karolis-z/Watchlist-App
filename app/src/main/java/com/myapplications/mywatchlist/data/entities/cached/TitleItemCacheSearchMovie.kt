...
@Entity(tableName = "remote_key_search_movie")
data class RemoteKeySearchMovie(
...
@Entity(tableName = "title_item_cache_search_movie")
data class TitleItemCacheSearchMovie(
...
@Entity(
    tableName = "genre_for_cache_item_search_movie",
    primaryKeys = ["id", "titleId"],
    foreignKeys = [ForeignKey(
        entity = TitleItemCacheSearchMovie::class,
        parentColumns = ["id"],
...
data class GenreForCacheItemSearchMovie(
...
data class TitleItemCacheSearchMovieFull(
    @Embedded override val titleItem: TitleItemCacheSearchMovie,
    @Relation(
        parentColumn = "id",
        entityColumn = "titleId",
        entity = GenreForCacheItemSearchMovie::class,
        projection = ["id","name"]
    )
